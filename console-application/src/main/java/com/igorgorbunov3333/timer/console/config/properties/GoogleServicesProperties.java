...
public class GoogleServicesProperties {
    ...
    @NotNull private Calendar calendar;

    @Data
    public static class Calendar {

        @NotNull private Summary summary;
        @NotNull private CalendarId id;
    ...
    public static class Summary {
        ...
        @NotBlank private String dayOff;
        @NotBlank private String pomodoro;
